        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    {{ __('Categories') }}
                    <a href="{{ route('admin.categories.create') }}" class="btn btn-primary">{{ __('Add New Category') }}</a>
                </div>
                            ...
                            <tbody>
                                @forelse ($categories as $category)
                                    <tr>
                                        ...
                                        <td>{{ $category->slug }}</td>
                                        <td>
                                            <a href="{{ route('admin.categories.edit', $category) }}" class="btn btn-sm btn-info">{{ __('Edit') }}</a>
