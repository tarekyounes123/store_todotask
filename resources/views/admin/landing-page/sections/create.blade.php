...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Create New Landing Page Section') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('admin.landing-page-sections.store') }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select id="section_type" class="form-select @error('section_type') is-invalid @enderror" name="section_type" required>
                                ...
                                <option value="newsletter" {{ old('section_type') == 'newsletter' ? 'selected' : '' }}>Newsletter</option>
                                <option value="about" {{ old('section_type') == 'about' ? 'selected' : '' }}>About Us</option>
                                <option value="contact" {{ old('section_type') == 'contact' ? 'selected' : '' }}>Contact</option>
